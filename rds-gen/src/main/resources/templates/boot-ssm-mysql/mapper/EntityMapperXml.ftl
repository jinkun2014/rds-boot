...
<#list EntityInfo.fieldInfoList as fieldInfo>
    <#if fieldInfo.primaryKey>
        <id column="${fieldInfo.columnName}" jdbcType="${fieldInfo.columnType}" property="${fieldInfo.name}"/>
    <#else>
        <result column="${fieldInfo.columnName}" jdbcType="${fieldInfo.columnType}" property="${fieldInfo.name}"/>
    </#if>
</#list>
    </resultMap>
