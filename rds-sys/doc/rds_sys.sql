...
MySQL - 5.7.18-log : Database - rds_sys_boot
*********************************************************************
*/
...
CREATE TABLE `sys_icon` (
  ...
  `del_mark` tinyint(1) DEFAULT NULL COMMENT '删除标记',
...
insert  into `sys_icon`(`id`,`name`,`url`,`type`,`del_mark`,`update_time`,`create_time`) values (1,'1-1.png','/images/32x32/1-1.png','32x32',NULL,NULL,NULL),(2,'1.png','/images/32x32/1.png','32x32',NULL,NULL,NULL),(3,'address.png','/images/32x32/address.png','32x32',NULL,NULL,NULL),(4,'administrative-docs.png','/images/32x32/administrative-docs.png','32x32',NULL,NULL,NULL),(5,'advertising.png','/images/32x32/advertising.png','32x32',NULL,NULL,NULL),(6,'archives.png','/images/32x32/archives.png','32x32',NULL,NULL,NULL),(7,'attibutes.png','/images/32x32/attibutes.png','32x32',NULL,NULL,NULL),(8,'bank.png','/images/32x32/bank.png','32x32',NULL,NULL,NULL),(9,'basket.png','/images/32x32/basket.png','32x32',NULL,NULL,NULL),(10,'bestseller.png','/images/32x32/bestseller.png','32x32',NULL,NULL,NULL),(11,'billing.png','/images/32x32/billing.png','32x32',NULL,NULL,NULL),(12,'bookmark.png','/images/32x32/bookmark.png','32x32',NULL,NULL,NULL),(13,'brainstorming.png','/images/32x32/brainstorming.png','32x32',NULL,NULL,NULL),(14,'business-contact.png','/images/32x32/business-contact.png','32x32',NULL,NULL,NULL),(15,'busy.png','/images/32x32/busy.png','32x32',NULL,NULL,NULL),(16,'calendar.png','/images/32x32/calendar.png','32x32',NULL,NULL,NULL),(17,'category.png','/images/32x32/category.png','32x32',NULL,NULL,NULL),(18,'check.png','/images/32x32/check.png','32x32',NULL,NULL,NULL),(19,'collaboration.png','/images/32x32/collaboration.png','32x32',NULL,NULL,NULL),(20,'comment.png','/images/32x32/comment.png','32x32',NULL,NULL,NULL),(21,'communication.png','/images/32x32/communication.png','32x32',NULL,NULL,NULL),(22,'config.png','/images/32x32/config.png','32x32',NULL,NULL,NULL),(23,'consulting.png','/images/32x32/consulting.png','32x32',NULL,NULL,NULL),(24,'contact.png','/images/32x32/contact.png','32x32',NULL,NULL,NULL),(25,'cost.png','/images/32x32/cost.png','32x32',NULL,NULL,NULL),(26,'credit-card.png','/images/32x32/credit-card.png','32x32',NULL,NULL,NULL),(27,'credit.png','/images/32x32/credit.png','32x32',NULL,NULL,NULL),(28,'current-work.png','/images/32x32/current-work.png','32x32',NULL,NULL,NULL),(29,'customers.png','/images/32x32/customers.png','32x32',NULL,NULL,NULL),(30,'cv.png','/images/32x32/cv.png','32x32',NULL,NULL,NULL),(31,'database.png','/images/32x32/database.png','32x32',NULL,NULL,NULL),(32,'date.png','/images/32x32/date.png','32x32',NULL,NULL,NULL),(33,'delicious.png','/images/32x32/delicious.png','32x32',NULL,NULL,NULL),(34,'document-library.png','/images/32x32/document-library.png','32x32',NULL,NULL,NULL),(35,'donate.png','/images/32x32/donate.png','32x32',NULL,NULL,NULL),(36,'drawings.png','/images/32x32/drawings.png','32x32',NULL,NULL,NULL),(37,'edit.png','/images/32x32/edit.png','32x32',NULL,NULL,NULL),(38,'email.png','/images/32x32/email.png','32x32',NULL,NULL,NULL),(39,'featured.png','/images/32x32/featured.png','32x32',NULL,NULL,NULL),(40,'feed.png','/images/32x32/feed.png','32x32',NULL,NULL,NULL),(41,'finished-work.png','/images/32x32/finished-work.png','32x32',NULL,NULL,NULL),(42,'flag.png','/images/32x32/flag.png','32x32',NULL,NULL,NULL),(43,'folder.png','/images/32x32/folder.png','32x32',NULL,NULL,NULL),(44,'free-for-job.png','/images/32x32/free-for-job.png','32x32',NULL,NULL,NULL),(45,'freelance.png','/images/32x32/freelance.png','32x32',NULL,NULL,NULL),(46,'full-time.png','/images/32x32/full-time.png','32x32',NULL,NULL,NULL),(47,'future-projects.png','/images/32x32/future-projects.png','32x32',NULL,NULL,NULL),(48,'graphic-design.png','/images/32x32/graphic-design.png','32x32',NULL,NULL,NULL),(49,'heart.png','/images/32x32/heart.png','32x32',NULL,NULL,NULL),(50,'hire-me.png','/images/32x32/hire-me.png','32x32',NULL,NULL,NULL),(51,'home.png','/images/32x32/home.png','32x32',NULL,NULL,NULL),(52,'illustration.png','/images/32x32/illustration.png','32x32',NULL,NULL,NULL),(53,'invoice.png','/images/32x32/invoice.png','32x32',NULL,NULL,NULL),(54,'issue.png','/images/32x32/issue.png','32x32',NULL,NULL,NULL),(55,'library.png','/images/32x32/library.png','32x32',NULL,NULL,NULL),(56,'lightbulb.png','/images/32x32/lightbulb.png','32x32',NULL,NULL,NULL),(57,'limited-edition.png','/images/32x32/limited-edition.png','32x32',NULL,NULL,NULL),(58,'link.png','/images/32x32/link.png','32x32',NULL,NULL,NULL),(59,'lock.png','/images/32x32/lock.png','32x32',NULL,NULL,NULL),(60,'login.png','/images/32x32/login.png','32x32',NULL,NULL,NULL),(61,'logout.png','/images/32x32/logout.png','32x32',NULL,NULL,NULL),(62,'milestone.png','/images/32x32/milestone.png','32x32',NULL,NULL,NULL),(63,'my-account.png','/images/32x32/my-account.png','32x32',NULL,NULL,NULL),(64,'networking.png','/images/32x32/networking.png','32x32',NULL,NULL,NULL),(65,'old-versions.png','/images/32x32/old-versions.png','32x32',NULL,NULL,NULL),(66,'order-1.png','/images/32x32/order-1.png','32x32',NULL,NULL,NULL),(67,'order.png','/images/32x32/order.png','32x32',NULL,NULL,NULL),(68,'payment-card.png','/images/32x32/payment-card.png','32x32',NULL,NULL,NULL),(69,'paypal.png','/images/32x32/paypal.png','32x32',NULL,NULL,NULL),(70,'pen.png','/images/32x32/pen.png','32x32',NULL,NULL,NULL),(71,'pencil.png','/images/32x32/pencil.png','32x32',NULL,NULL,NULL),(72,'phone.png','/images/32x32/phone.png','32x32',NULL,NULL,NULL),(73,'photography.png','/images/32x32/photography.png','32x32',NULL,NULL,NULL),(74,'plus.png','/images/32x32/plus.png','32x32',NULL,NULL,NULL),(75,'premium.png','/images/32x32/premium.png','32x32',NULL,NULL,NULL),(76,'print.png','/images/32x32/print.png','32x32',NULL,NULL,NULL),(77,'process.png','/images/32x32/process.png','32x32',NULL,NULL,NULL),(78,'product-1.png','/images/32x32/product-1.png','32x32',NULL,NULL,NULL),(79,'product-design.png','/images/32x32/product-design.png','32x32',NULL,NULL,NULL),(80,'product.png','/images/32x32/product.png','32x32',NULL,NULL,NULL),(81,'project.png','/images/32x32/project.png','32x32',NULL,NULL,NULL),(82,'publish.png','/images/32x32/publish.png','32x32',NULL,NULL,NULL),(83,'refresh.png','/images/32x32/refresh.png','32x32',NULL,NULL,NULL),(84,'search.png','/images/32x32/search.png','32x32',NULL,NULL,NULL),(85,'settings.png','/images/32x32/settings.png','32x32',NULL,NULL,NULL),(86,'shipping.png','/images/32x32/shipping.png','32x32',NULL,NULL,NULL),(87,'showreel.png','/images/32x32/showreel.png','32x32',NULL,NULL,NULL),(88,'sign-in.png','/images/32x32/sign-in.png','32x32',NULL,NULL,NULL),(89,'sign-out.png','/images/32x32/sign-out.png','32x32',NULL,NULL,NULL),(90,'sign-up.png','/images/32x32/sign-up.png','32x32',NULL,NULL,NULL),(91,'sitemap.png','/images/32x32/sitemap.png','32x32',NULL,NULL,NULL),(92,'special-offer.png','/images/32x32/special-offer.png','32x32',NULL,NULL,NULL),(93,'star.png','/images/32x32/star.png','32x32',NULL,NULL,NULL),(94,'statistics.png','/images/32x32/statistics.png','32x32',NULL,NULL,NULL),(95,'suppliers.png','/images/32x32/suppliers.png','32x32',NULL,NULL,NULL),(96,'tag.png','/images/32x32/tag.png','32x32',NULL,NULL,NULL),(97,'ticket.png','/images/32x32/ticket.png','32x32',NULL,NULL,NULL),(98,'twitter.png','/images/32x32/twitter.png','32x32',NULL,NULL,NULL),(99,'upcoming-work.png','/images/32x32/upcoming-work.png','32x32',NULL,NULL,NULL),(100,'user.png','/images/32x32/user.png','32x32',NULL,NULL,NULL),(101,'world.png','/images/32x32/world.png','32x32',NULL,NULL,NULL),(102,'zoom.png','/images/32x32/zoom.png','32x32',NULL,NULL,NULL);
...
CREATE TABLE `sys_org` (
  ...
  `is_leaf` tinyint(1) DEFAULT NULL COMMENT '叶子节点',
